...
class MatchCuratorService {
     ...
     * - +2000 points if match involves user's favorite team (Phase 4)
     */
    private fun calculateExcitementScore(
        ...
        // Phase 4: Favorite team bonus (+2000 points)
        // TODO: Implement favorite team scoring when we have team IDs in MatchFixture
        // For now, favorite team scoring is disabled
        // if (favoriteTeamId != null) {
        //     // Check if either home or away team matches the favorite team
        //     // Need team IDs in MatchFixture to implement this properly
        // }
